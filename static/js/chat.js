  ...
  function get(){
    ...
    chatCollection.where('id_empleado', '==', `${userID}`)
    .onSnapshot(function(doc){
        ...
        salas.map((hola, index) => {
            ...
            <div class="chat_ib">
                ...
                <h5 id="h${index}">${hola.nombre_empresa}</h5>
...
function mostrarChat(index){
    ...
    idchatt = id_chat;
    var id_empleado = document.getElementById(`id_empleado${index}`).innerHTML;
