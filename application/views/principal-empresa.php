...
<html lang="en">
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('<?=base_url() ?>static/images/bg_2.jpg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          ...
          <h1 class="mb-5" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Encuentre al mejor<br><span>candidato para su empresa</span></h1>
    <div class="ftco-search">
              <!--<div class="row">
                <div class="col-md-12 nav-link-wrap">
                  <a class="nav-link active mr-md-1" aria-selected="true">Encuentre una solicitud</a>
                </div>
                          ...
                          <div class="col-md">
                            <div class="form-group">
                              <div class="form-field">
                                ...
                                <input type="text" class="form-control" placeholder="Nombre de solicitante">
                              </div>
                            </div>
                          </div>
                          <div class="col-md">
                          ...
                          <div class="col-md">
                            <div class="form-group">
                              <div class="form-field">
                                ...
                                <input type="date" class="form-control" value="2020-07-23" min="1945-08-21" max="2999-12-31">
                              </div>
                            </div>
                          </div>
                          <div class="col-md">
		...
		<section class="ftco-section bg-light">
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
          	<span class="subheading">Bandeja de solicitudes</span>
            <h2 class="mb-4"><span>Solicitudes</span> Recientes</h2>
          </div>
        </div>
        ...
        <!-- The Modal -->
        <div class="modal" id="modal-soli">
          <div class="modal-dialog">
            <div class="modal-content">

              <!-- Modal Header -->
              <div class="modal-header bg-info">
                <h4 id="vacante" class="modal-title text-white">Vacante</h4>
              ...
              <div class="modal-body bg-info">
                ...
                <!-- The slideshow -->
                <div id="solicitudes" class="carousel-inner">
                  ...
                  <div class="carousel-item">
                    <img src="images/tiger.jpg" class="mx-auto d-block mt-3 rounded-circle" style="height: 200px; width: 200px;" alt="Los Angeles">
                    <div class="mt-3">
                      <div class="col d-flex justify-content-center mb-3">
                        <span class="border bg-info text-white rounded p-1">Experiencia:</span>  
                      </div>
  ...
  <script src="<?=base_url() ?>static/js/empresa.js"></script>
